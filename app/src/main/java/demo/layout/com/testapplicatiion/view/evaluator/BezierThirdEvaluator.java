package demo.layout.com.testapplicatiion.view.evaluator;
 ...
 * 三次贝塞尔曲线
 */
public class BezierThirdEvaluator implements TypeEvaluator<PointF> {

    private final PointF mControlP1;
    private final PointF mControlP2;

    public BezierThirdEvaluator(PointF pointF1, PointF pointF2) {
